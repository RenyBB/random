    ...
    class HtmlSliderResponsePlugin {
        ...
        trial(display_element, trial) {
            ...
            function handleSliderKey(e) {
                ...
                if(e.key == 'a') {
                  slider.value = Math.max(trial.min, slider.value - trial.step);
                }
                if(e.key == 's') {
                  slider.value = Math.min(trial.max, slider.value + trial.step);
                }
            ...
            document.addEventListener('keydown', handleSliderKey);
            ...
            const end_trial = () => {
                ...
                document.removeEventListener('keydown', handleSliderKey);
                // next trial
